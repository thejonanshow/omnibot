...
- 1. Route commits@certora.dev to this worker
- 1. Deploy with HMAC_SECRET and GITHUB_TOKEN
- 
- Flow:
- 1. Claude composes email with COMMIT_REQUEST
- 1. User sends to commits@certora.dev
- 1. Cloudflare routes email to this worker
- 1. Worker parses and commits to GitHub
   */
